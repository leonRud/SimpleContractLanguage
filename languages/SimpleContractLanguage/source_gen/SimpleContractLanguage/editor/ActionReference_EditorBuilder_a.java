...
/*package*/ class ActionReference_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ActionReference_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.Action$aPpB;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.Action$aPpB);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.Action$aPpB);
    }
    editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new ReferenceCellContext(getNode(), getNode(), referenceLink), new SubstituteInfoPartExt[]{new ActionReference_Action_cellMenu_ld3k57_a0a0(), new ActionReference_generic_cellMenu_ld3k57_b0a0(), new SChildSubstituteInfoPartEx(editorCell)}));
  ...
  public static class ActionReference_Action_cellMenu_ld3k57_a0a0 extends PrimaryReferentMenuCellMenuPart {
    public ActionReference_Action_cellMenu_ld3k57_a0a0() {
    }
  }
  public static class ActionReference_generic_cellMenu_ld3k57_b0a0 extends AbstractCellMenuPart_Generic_Item {
    public ActionReference_generic_cellMenu_ld3k57_b0a0() {
    }
    @Override
        ...
        public SubstituteAction apply(SubstituteAction action) {
          return new NodeSubstituteActionWrapper(action) {
            ...
            public EditorMenuTraceInfo getEditorMenuTraceInfo() {
              ...
              result.setDescriptor(new EditorMenuDescriptorBase("generic item", new SNodePointer("r:b8512c0c-bfa5-47fc-949e-5404bc6fb307(SimpleContractLanguage.editor)", "3398912544637867585")));
              return result;
            }
          };
        }
