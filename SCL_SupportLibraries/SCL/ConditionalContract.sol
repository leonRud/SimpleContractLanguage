...
contract ConditionalContract {
    ...
    function clauseAllowed(bytes32 _clauseId) virtual internal returns(bool);
    function clauseFulfilledTime(bytes32 _clauseId) virtual internal returns(uint);
    function contractObeyed() virtual internal returns(bool);
}